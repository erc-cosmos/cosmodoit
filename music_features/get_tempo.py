...
if __name__ == '__main__':
    ...
    parser.add_argument("-plot", "--plotTempo",   action='store_true',
                        help="Plot tempo curve, default False", default=False)
    parser.add_argument("-noPlot", "--dontPlot",  action='store_false',
                        help="Do not plot tempo curve", dest='plotTempo')
    parser.add_argument("-exp", "--exportTempo",  action='store_true',
                        help="Export tempo as csv, default True", default=True)
    parser.add_argument("-noExp", "--dontExport", action='store_false',
                        help="Do not export tempo as csv", dest='exportTempo')
